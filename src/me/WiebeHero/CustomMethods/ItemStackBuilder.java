...
public class ItemStackBuilder {
	...
	public ItemStack constructItem(Material mat, String lore[]) {
		ItemStack item = new ItemStack(mat, 1);
		ItemMeta meta = item.getItemMeta();
		ArrayList<String> newLore = new ArrayList<String>();
		for(int i = 0; i < lore.length; i++) {
			if(lore[i] != null) {
				newLore.add(new CCT().colorize(lore[i]));
			}
		}
	...
	public ItemStack constructItem(Material mat, String display, String lore[]) {
		ItemStack item = new ItemStack(mat, 1);
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(new CCT().colorize(display));
		ArrayList<String> newLore = new ArrayList<String>();
	...
	public ItemStack constructItem(Material mat, String display, String lore[], Pair... pair) {
		ItemStack item = new ItemStack(mat, 1);
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(new CCT().colorize(display));
		ArrayList<String> newLore = new ArrayList<String>();
	...
	public ItemStack constructItem(Material mat, int amount, String lore[]) {
		ItemStack item = new ItemStack(mat, amount);
		ItemMeta meta = item.getItemMeta();
		ArrayList<String> newLore = new ArrayList<String>();
		for(int i = 0; i < lore.length; i++) {
	...
	public ItemStack constructItem(Material mat, int amount, String display, String lore[]) {
		ItemStack item = new ItemStack(mat, amount);
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(new CCT().colorize(display));
		ArrayList<String> newLore = new ArrayList<String>();
	...
	public ItemStack constructItem(Material mat, int amount, String display, String lore[], Pair... pair) {
		ItemStack item = new ItemStack(mat, amount);
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(new CCT().colorize(display));
		ArrayList<String> newLore = new ArrayList<String>();
	...
	public ItemStack constructItem(ItemStack stack, String lore[]) {
		ItemStack item = new ItemStack(stack);
		ItemMeta meta = item.getItemMeta();
		ArrayList<String> newLore = new ArrayList<String>();
		for(int i = 0; i < lore.length; i++) {
	...
	public ItemStack constructItem(ItemStack stack, String display, String lore[]) {
		ItemStack item = new ItemStack(stack);
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(new CCT().colorize(display));
		ArrayList<String> newLore = new ArrayList<String>();
	...
	public ItemStack constructItem(ItemStack stack, String display, String lore[], Pair... pair) {
		ItemStack item = new ItemStack(stack);
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(new CCT().colorize(display));
		ArrayList<String> newLore = new ArrayList<String>();
	...
	public ItemStack constructItem(ItemStack stack, int amount, String display, String lore[], Pair... pair) {
		ItemStack item = new ItemStack(stack);
		stack.setAmount(amount);
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(new CCT().colorize(display));
	...
	public ItemStack constructItem(ItemStack stack, int amount, String lore[]) {
		ItemStack item = new ItemStack(stack);
		item.setAmount(amount);
		ItemMeta meta = item.getItemMeta();
		ArrayList<String> newLore = new ArrayList<String>();
	...
	public ItemStack constructItem(ItemStack stack, int amount, String display, String lore[]) {
		ItemStack item = new ItemStack(stack);
		item.setAmount(amount);
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(new CCT().colorize(display));
